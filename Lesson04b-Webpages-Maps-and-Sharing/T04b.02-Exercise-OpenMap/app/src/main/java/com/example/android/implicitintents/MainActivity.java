...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        String AdressString="Carrer Riu guell 186,Girona";
        Uri.Builder builder=new Uri.Builder();
        builder.scheme("geo").path("0.0").query(AdressString);
        Uri adresUri=builder.build();

        Intent intent = new Intent(Intent.ACTION_VIEW, adresUri);
