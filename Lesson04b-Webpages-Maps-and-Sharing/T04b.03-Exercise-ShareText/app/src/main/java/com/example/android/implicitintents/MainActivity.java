...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String estringToShare="hellow my name is ibrahima";
       Intent builderShare= ShareCompat.IntentBuilder.from(this)
                .setChooserTitle("learning how to share")
                .setType("text/plain")
                .setText("my name is ibrahima")
               .getIntent();

        if (builderShare.resolveActivity(getPackageManager()) != null) {
            startActivity(builderSharex);
        }
     ...
     * @param v Button that was clicked.
     */
    public void createYourOwn(View v) {i-
        Toast.makeText(this,
