    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        for(int i=0;i<count;i++){
            ...
            if(!(p instanceof CheckBoxPreference)){
                ...
                setPreferenceSummury(p,value);
            }
        }
    }
   private void setPreferenceSummury(Preference preference,String value){
       //pre: receive apreference as an arguments and String as well as arguments
       //post:compute the the preference and the string
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if(null !=preference){
            if(!(preference instanceof CheckBoxPreference)){
                ...
                setPreferenceSummury(preference,value);
            }
        }
    }
