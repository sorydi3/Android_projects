...
/*
  load the prefered color from preferences
 */
    private void loadPreferenceColor(SharedPreferences sharedPreferences){
        mVisualizerView.setColor(sharedPreferences.getString(getString(R.string.key_color),getString(R.string.pref_color_red_label)));
    }
