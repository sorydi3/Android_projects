...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (27) Create a TextView variable called mUrlDisplayText
   ...
   private TextView mTextViewSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewUrl=(TextView)findViewById(R.id.tv_url_display);
        // TODO (31) Use findViewById to get a reference to mSearchResultsTextView
        mTextViewSearch=(TextView)findViewById(R.id.et_search_box);
    }
}
