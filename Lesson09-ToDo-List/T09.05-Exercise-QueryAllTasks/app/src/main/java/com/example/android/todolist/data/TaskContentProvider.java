...
public class TaskContentProvider extends ContentProvider {
    ...
    int match=sUriMatcher.match(uri);
        // TODO (3) Query for the tasks directory and write a default caseCursor cur
        Cursor cursor;
          switch (match){
              case TASKS:
                  cursor=db.query(TaskContract.TaskEntry.TABLE_NAME,projection,selection,selectionArgs,null,null,TaskContract.TaskEntry.COLUMN_PRIORITY);
                  break;
              default:
                  throw new UnsupportedOperationException("UNKNOWN URI"+uri);
          }
