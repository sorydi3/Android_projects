...
private IntentFilter intentFilter;
   private brodacastReceiver mBrocastReceiver;
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mBrocastReceiver,intentFilter);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mBrocastReceiver=new brodacastReceiver();
    ...
    private class brodacastReceiver extends BroadcastReceiver{

        @Override
        public void onReceive(Context context, Intent intent) {
            String acction=intent.getAction();
            boolean isCharging=(acction.equals(Intent.ACTION_POWER_CONNECTED));
