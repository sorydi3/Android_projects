...
public class NotificationUtils {
    private static final int WATER_REMINDER_PENDING_INTENT_ID =2598 ;
    ...
    public static void remindUserBecauseCharging(Context context){
        ...
        NotificationCompat.Builder  notificationBuilder=new NotificationCompat.Builder(context).setColor(ContextCompat.getColor(context,R.color.colorPrimary))
                ...
                .setAutoCancel(true);
       // if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.JELLY_BEAN && Build.VERSION.SDK_INT<Build.VERSION_CODES.)
    ...
    private static Bitmap largeIcon(Context context){
        ...
        Bitmap largeIcon= BitmapFactory.decodeResource(re,R.drawable.ic_local_drink_black_24px);
        return largeIcon;
    }
