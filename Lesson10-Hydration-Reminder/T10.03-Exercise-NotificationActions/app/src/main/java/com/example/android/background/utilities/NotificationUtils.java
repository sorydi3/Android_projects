...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 2454;
    private static final int ACTION_DRINK_PRNDING_INTENT_ID =4654 ;
...
public static void ClearAllNotifications(Context context){
    ...
    public static void remindUserBecauseCharging(Context context) {
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
                ...
                .addAction(IgnoreReminderAccion(context))
  ...
  private static NotificationCompat.Action IgnoreReminderAccion(Context context){
      Intent ignoreReminderIntent=new Intent (context, WaterReminderIntentService.class);
      ignoreReminderIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
      PendingIntent ignoreReminderIntentPending=PendingIntent.getService(context,ACTION_IGNORE_PENDING_INTENT_ID,
              ignoreReminderIntent,PendingIntent.FLAG_UPDATE_CURRENT);
      NotificationCompat.Action ignoreReminderAction=new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,"No thanks",ignoreReminderIntentPending);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        PendingIntent ignoreReminderIntentPending=PendingIntent.getService(context,ACTION_DRINK_PRNDING_INTENT_ID,
                ignoreReminderIntent,PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Action ignoreReminderAction=new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,"I did it!",ignoreReminderIntentPending);
        return  ignoreReminderAction;
    }
